...
Señale todas las opciones correctas. Suponga que la matriz $A$ (que aparece mas abajo) corresponde a la matriz aumentada de un sistema de ecuaciones lineales ( **SEL** ). En relación con el **SEL** que representa la matriz $A$, es correcto afirmar:
...
Meta-information
================
exname: matriz_SEL_infinitas
extype: mchoice
exsolution: 101001011001
exshuffle: 7

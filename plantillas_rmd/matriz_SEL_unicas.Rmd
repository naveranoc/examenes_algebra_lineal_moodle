...
* Suponiendo que $x$ denota la primera incógnita, $y$ la segunda y $z$ la tercera, entonces la solución del **SEL** determina que: $y = `r v`$ y $z = `r w`$.
